...
MoneyKawKaw manages money effortlessly by replacing static charts and overwhelming balances with proactive, automated decision-making.

![image](https://github.com/HRChiam/MoneyKawKaw/blob/main/readme_picture.png)

### 1. AI Smart Budgeting
* **Auto-Generation:** Automatically generates categorical spending limits based on the user's current lifestyle and income.
* **Continuous Learning:** Machine learning models learn spending habits over time and predict future monthly category expenditures.
* **Dynamic Adjustment:** Dynamically adjusts monthly allocations across categories based on predictive needs.

### 2. Daily Spending
* **Actionable Simplicity:** Instead of overwhelming users with complex charts, the app simplifies daily budgeting into a clear **"Safe to Spend Today"** daily limit.
* **Real-Time Friction & Nudges:** Intervenes exactly when needed to keep users within their financial boundaries.

### 3. AI Debt & Savings Assistant
* **Surplus Allocation:** Automatically optimizes the allocation of surplus funds.
* **Debt Repayment:** Prioritizes high-interest debt repayment to minimize financial burdens.
* **Product Recommendations:** Suggests smarter GXBank financial products tailored to the user's specific financial situation.
...
* **Machine Learning (Predictive Analysis):** Learns from historical spending patterns to predict upcoming category costs (e.g., predicting food expenses rising from RM500 to RM600).
...
5. Open the app using either:
   - Android Studio emulator: press "a" in the terminal
   - Mobile device: scan the QR code in the terminal using the Expo Go app
